...
<body background="./images/hanep.gif">
	...
	<form action="http://localhost:8080/developmentExercise/goodsMaintenance/_GoodsMaintenance1" method="POST">
