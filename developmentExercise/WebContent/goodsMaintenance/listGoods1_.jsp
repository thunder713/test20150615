...
%>
	...
	<TD id="formAddGoods">
		<!-- 商品追加リクエストフォーム -->
		<FORM method="POST" action="addGoods1_.jsp">
...
%>
		...
		<TD id="list" style="width:50px; text-align:center;"><a href="./updateGoods_.jsp?goodsID=<%= goodsID%>">更新</a></TD>
		<TD id="list" style="width:50px; text-align:center;"><a href="./deleteGoods_.jsp?goodsID=<%= goodsID%>">削除</a></TD>
	</TR>
<%
